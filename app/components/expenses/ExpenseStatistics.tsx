...
import { Expense, Statistic } from "~/models/expenses";

const calculateSummaryStatistics = (expenses: Array<Expense>): Statistic => {
...
const ExpenseStatistics = ({ expenses }: ExpenseStatisticsProps) => {
  const { minAmount, maxAmount, sum, mean } = useMemo<Statistic>(
